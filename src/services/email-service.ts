              ...
              <tr style="${idx % 2 === 0 ? 'background-color: #2C2C2E;' : 'background-color: #1C1C1E;'} border-bottom: 1px solid #48484A;">
                <td style="padding: 16px; color: #E5E5EA; font-size: 17px;">
                  <div style="max-width: 300px; overflow: hidden; text-overflow: ellipsis; white-space: nowrap;">
                    ${page.page.replace(new RegExp(`https?://${(data.websiteDomain || 'unknown').replace(/[.*+?^${}()|[\]\\]/g, '\\$&')}`, 'gi'), '')}
                  </div>
                </td>
      ...
      <table style="width: 100%;">
        <tr>
          <td style="text-align: center;">
            <p style="margin: 0 0 8px 0; color: #98989D; font-size: 13px; font-weight: 400;">This report was automatically generated by Stuchai SEO Monitoring System.</p>
            <p style="margin: 0 0 8px 0; color: #98989D; font-size: 13px; font-weight: 400;">Data source: Google Search Console | ${data.websiteDomain}</p>
